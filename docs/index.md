...
The bot connects to a Last.fm account to see your listening history. Over 450.000 users have already connected. To get started, simply use `/login`.
...
.fmbot is trusted by over 200.000 servers, has over 450.000 registered users, and is used more than 300.000 times every day.
