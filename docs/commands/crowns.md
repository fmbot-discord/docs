...
!!! note cmd-slash "Examples"
    ...
    `/crowns user:frikandel_`

    `/crowns view:Recent`
    
---
### .crown (`.cw`) { data-slash="/crown" }
...
!!! note cmd-slash "Examples"
    ...
    `/crown artist:the beatles`

    `/crown artist:tame impala user:frikandel_`
...
---   
### .crownleaderboard (`.cwlb`) { .text-only }
